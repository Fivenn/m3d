...
/**
 * Les macros ci dessous doivent permettre l'utilisation des champs de la structure comme lvalue (dans les lib_surface*.c)
 * ou rvalue (dans lib_2d.c) en cas de compilation avec SDL ou SDL2. Il est cependant imperatif d'avoir ces champs en debut
 * de structure pour eviter un changement du profil binaire du debut de la structure et ainsi compiler lib_2d.c sans passer
 * de valeur pour COMPIL_SDL2
 */
